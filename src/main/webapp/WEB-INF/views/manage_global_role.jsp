...
<title>Manage Global Role</title>
...
<sec:authentication property="principal.username" var="username" /> 
	<div class="manageglobal">
	  ...
	  <br><br><br><br><br><br>
	  <h1><b>Manage Global Role</b></h1>
	  <br><br><br>
	  	<form:form method="post" action="submitglobalrole" modelAttribute="roleForm">
			<table id="manageGlobalRoles" bgcolor="#fff">
				<tr>
					<th> </th>
					<th>Role</th>
					 <th>start</th>
			...
			<br/>
			<br/>
			   <label>Add Global Role</label> <input type="text" id="addrole" value=""/> 
			    <br/><br>
				<input type="button" value="Add" id="add" onclick="addRow('manageGlobalRoles')" style="margin-left: 200px"/>
			<br/> <br/>
	...
	{
		try{
			var table=document.getElementById('manageGlobalRoles');
			var rownumber=parseInt(this.id);
			var row=table.rows[rownumber+1];
			if(rownumber+1 == 1 && row.cells[1].childNodes[2].value =='admin')
				{
